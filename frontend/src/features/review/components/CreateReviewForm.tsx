...
export default function CreateReviewForm({ eventId, onSuccess }: CreateReviewFormProps) {
          ...
          `}
            ...
            <div className="mb-4">
                <textarea
                    ...
                    className={`w-full p-3 border rounded-lg focus:ring-2 outline-none resize-none text-sm text-gray-700 placeholder-gray-400 ${formik.touched.comment && formik.errors.comment
