    ...
    <form onSubmit={formik.handleSubmit} className="grid grid-cols-2 gap-4">
      ...
      <div className="flex flex-col gap-1 col-span-2 md:col-span-1">
        ...
        {getFieldError("startDate") && (
          <span className="text-xs text-red-500">
            {String(getFieldError("startDate"))}
          </span>
        )}
      </div>
        ...
        >
          ...
          <div className="col-span-3 md:col-span-1">
            ...
            <input
              ...
              value={ticket.price}
              onChange={(e) =>
                handleTicketChange(ticket.id, "price", Number(e.target.value))
              }
          ...
          <div className="col-span-3 md:col-span-1">
            ...
            <input
              ...
              value={ticket.seats}
              onChange={(e) =>
                handleTicketChange(ticket.id, "seats", Number(e.target.value))
              }
              placeholder="e.g 200"
              className="border border-gray-300 rounded-md p-2 pr-3 w-full
                 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 
