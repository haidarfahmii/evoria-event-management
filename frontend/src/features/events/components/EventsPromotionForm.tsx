...
export default function EventsPromotionForm({
    ...
    async function handleDelete(id: string) {
        if (window.confirm("Are you sure you want to permanently delete this promotion?")) {
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        value={
                            data.startDate
                                ? new Date(new Date(data.startDate).getTime() - new Date().getTimezoneOffset() * 60000)
                                    .toISOString()
                                    .split('T')[0]
                                : ""
                        }
                ...
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        value={
                            data.endDate
                                ? new Date(new Date(data.endDate).getTime() - new Date().getTimezoneOffset() * 60000)
                                    .toISOString()
                                    .split('T')[0]
                                : ""
                        }
