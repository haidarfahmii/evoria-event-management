    ...
    return (
        ...
        >
            <div className="mb-6 flex items-center justify-between">
                <h3 className="text-lg font-bold text-blue-900">Create New Promotion</h3>
                <Button
                    type="button"
                    variant="ghost"
                    size="sm"
            ...
            <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                ...
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        className={`bg-white ${formik.touched.code && formik.errors.code
                ...
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                        className={`bg-white ${formik.touched.value && formik.errors.value
                                ? "border-red-500 focus-visible:ring-red-500"
                                : ""
                            }`}
                    />
                ...
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                        className={`bg-white ${formik.touched.maxUsage && formik.errors.maxUsage
                                ? "border-red-500 focus-visible:ring-red-500"
                                : ""
                            }`}
                    />
                ...
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                        className={`bg-white ${formik.touched.startDate && formik.errors.startDate
                                ? "border-red-500 focus-visible:ring-red-500"
                                : ""
                            }`}
                    />
                ...
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                        className={`bg-white ${formik.touched.endDate && formik.errors.endDate
                                ? "border-red-500 focus-visible:ring-red-500"
                                : ""
                            }`}
                    />
